...
void renderMode8(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    const glm::vec4 kDefaultColor = {0.5f, 0.5f, 0.5f, 1.0f}; // Gray as default
    ...
    float scale = 1.0f + 0.15f * std::sin(wavePhase) * zoomLevel * (cache.empty() ? 1.0f : static_cast<float>(cache[0].observable));
    ...
    const glm::vec4 colors[] = {
        {0.5f, 0.5f, 0.5f, 1.0f}, {0.6f, 0.6f, 0.6f, 1.0f}, {0.7f, 0.7f, 0.7f, 1.0f},
        {0.8f, 0.8f, 0.8f, 1.0f}, {0.9f, 0.9f, 0.9f, 1.0f}, {1.0f, 1.0f, 1.0f, 1.0f},
        {0.4f, 0.4f, 0.4f, 1.0f}, {0.3f, 0.3f, 0.3f, 1.0f}
    };
