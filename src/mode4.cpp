// File: mode4.cpp (compile to mode4.o)
// Mode 4: Pulsating sphere for dimension 4 with perspective, centered and zoomed out
...
void renderMode4(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(4) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
