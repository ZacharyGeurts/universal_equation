...
void renderMode5(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    const glm::vec4 kDefaultColor = {1.0f, 0.0f, 1.0f, 1.0f}; // Magenta as default
    ...
    auto renderInstance = [&](const UniversalEquation::DimensionInteraction& interaction, float strengthMod, const glm::vec4& iColor) {
        ...
        glm::vec4 modColor = iColor * (0.5f + 0.5f * static_cast<float>(interaction.strength));
    ...
    const glm::vec4 colors[] = {
        {1.0f, 0.0f, 1.0f, 1.0f}, {0.8f, 0.2f, 0.8f, 1.0f}, {0.6f, 0.4f, 0.6f, 1.0f},
        {0.4f, 0.6f, 0.4f, 1.0f}, {0.2f, 0.8f, 0.2f, 1.0f}, {0.0f, 1.0f, 0.0f, 1.0f},
