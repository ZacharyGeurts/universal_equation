// File: mode5.cpp (compile to mode5.o)
// Mode 5: Pulsating sphere for dimension 5 with perspective, centered and zoomed out
...
void renderMode5(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(5) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
