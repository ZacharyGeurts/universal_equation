// File: mode9.cpp (compile to mode9.o)
// Mode 9: Pulsating sphere for dimension 9 with perspective, centered and zoomed out
...
void renderMode9(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(9) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
