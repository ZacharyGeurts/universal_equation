// File: mode7.cpp (compile to mode7.o)
// Mode 7: Pulsating sphere for dimension 7 with perspective, centered and zoomed out
...
void renderMode7(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(7) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
