// File: mode6.cpp (compile to mode6.o)
// Mode 6: Pulsating sphere for dimension 6 with perspective, centered and zoomed out
...
void renderMode6(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(6) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
