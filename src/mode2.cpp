// File: mode2.cpp (compile to mode2.o)
// Mode 2: Pulsating sphere for dimension 2 with perspective, centered and zoomed out
...
void renderMode2(AMOURANTH* amouranth, uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(2) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
