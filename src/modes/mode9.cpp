// src/modes/mode9.cpp
// AMOURANTH RTX Engine, October 2025 - RenderMode9 for 9D perspective.
// Implements rendering for a 3D slice of a 9D hypercube.
// Zachary Geurts, 2025
...
void renderMode9(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer,
    ...
    glm::mat4 proj = glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f)) *
    ...
    glm::mat4 model = glm::scale(glm::mat4(1.0f), glm::vec3(scale * 0.4f, scale * 0.4f, scale * 0.4f));
