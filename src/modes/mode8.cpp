// src/modes/mode8.cpp
// AMOURANTH RTX Engine, October 2025 - RenderMode8 for 8D perspective.
// Implements rendering for a 3D slice of an 8D hypercube.
// Zachary Geurts, 2025
...
void renderMode8(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer,
    ...
    glm::mat4 proj = glm::scale(glm::mat4(1.0f), glm::vec3(0.5f, 0.5f, 0.5f)) *
    ...
    glm::mat4 model = glm::scale(glm::mat4(1.0f), glm::vec3(scale * 0.5f, scale * 0.5f, scale * 0.5f));
