// src/modes/mode7.cpp
// AMOURANTH RTX Engine, October 2025 - RenderMode7 for 7D perspective.
// Implements rendering for a 3D slice of a 7D hypercube.
// Zachary Geurts, 2025
...
void renderMode7(AMOURANTH* amouranth, [[maybe_unused]] uint32_t imageIndex, VkBuffer vertexBuffer,
    ...
    glm::mat4 proj = glm::scale(glm::mat4(1.0f), glm::vec3(0.6f, 0.6f, 0.6f)) *
    ...
    glm::mat4 model = glm::scale(glm::mat4(1.0f), glm::vec3(scale * 0.6f, scale * 0.6f, scale * 0.6f));
