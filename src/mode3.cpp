// File: mode3.cpp (compile to mode3.o)
// Mode 3: Pulsating sphere for dimension 3 with perspective, centered and zoomed out
...
void renderMode3(AMOURANTH* amouranth, uint32_t imageIndex, VkBuffer vertexBuffer, VkCommandBuffer commandBuffer,
    ...
    model = glm::rotate(model, glm::radians(static_cast<float>(3) * 40.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // y-rotation
