...
sudo rm -rf bzip2 libffi libpng pixman icu icu-host pcre2 glib freetype harfbuzz cairo icu/cairo
...
meson setup --cross-file=$BASE_DIR/mingw64-cross.ini \
    ...
    -Dxlib=disabled -Dxcb=disabled -Dxlib-xcb=disabled -Dwin32-surface=enabled \
